...
| Barbetreiber
| Besitzt, betreibt Bar
| Herstellung Cocktails, Auftraggeber

| Kunde
| lebt in der Region in der die Bar sich befindet
| Bestellt, bezahlt Cocktails

| Gesetzgeber
| gibt gesetzlichen Rahmen vor
| Datenschutzgesetz, Verbraucherschutzgesetz...

| Mitarbeiter
| arbeitet in Bar, unterstützt Besitzer
| Herstellung Cocktails
